    ...
    for i, line in enumerate(lines):
        ...
        for link in matches:
            ...
            if not target_path.exists():
                ...
                results.append(f"{file_path.relative_to(workspace_root)} | {i+1} | {link} | {status} | {suggestion_str}")
                ...
                results.append(f"{file_path.relative_to(workspace_root)} | {i+1} | {link} | error | Points to directory")
